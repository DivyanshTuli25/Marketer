...
if selected == "Home":
    ...
    if submitted:
        ...
        develop_marketing_strategy = Task(
            description=f"Use the gathered insights and marketing budget of {marketing_budget} USD to create a comprehensive marketing strategy that includes goals, initiatives, schedules, activities, and status tracking.",
